	...
	public ArrayList<Plant> readAllPlants(){
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				Boolean bool = Boolean.parseBoolean(plantInfo[3]);
				Plant p = new Plant(plantInfo[0], plantInfo[1], Integer.parseInt(plantInfo[2]), bool, plantInfo[4], plantInfo[5], Integer.parseInt(plantInfo[6]), Integer.parseInt(plantInfo[7]));
				p.hasFruit = bool;
				temp.add(p);
